...
class CategoriesViewController: UIViewController {
    ...
    func loadCategories() {        
        ...
        do {
            dataSource = try context.fetch(fetchRequest) // alternate method of fetch used for smaller lists
...
extension CategoriesViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, editActionsForRowAt indexPath: IndexPath) -> [UITableViewRowAction]? {
        ...
        let deleteAction = UITableViewRowAction(style: .destructive, title: CategoryType.delete.rawValue) { (action: UITableViewRowAction, indexPath: IndexPath) in
        ...
        let editAction = UITableViewRowAction(style: .normal, title: CategoryType.edit.rawValue) { (action: UITableViewRowAction, indexPath: IndexPath) in
